        ...
        <div className="container mt-4">
            <div className="row">
                <div className="col-lg-12">
                    <h1 className="m-3 text-center"> {allproduct.length} : Product Management </h1>
                    <p className="text-center text-danger"> {msg} </p>
                    <p className="text-center">
                        <input type="text" className="m-3" placeholder="Name" onChange={obj=>pickName(obj.target.value)} value={pname}/>
                        <input type="text" className="m-3" placeholder="Price" onChange={obj=>pickPrice(obj.target.value)} value={pprice}/>
                        <input type="text" className="m-3" placeholder="Qty" onChange={obj=>pickQty(obj.target.value)} value={pqty}/>
                        <button className="btn btn-primary m-3" onClick={save}> Save Product </button>
                    </p>
